...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactRedux = __webpack_require__(168);
	var thunkMiddleware = __webpack_require__(177);
	var fetch = __webpack_require__(178);
	...
	var fetchTags = function () {
	  return function (dispatch) {
	    ...
	    return fetch(api + "/tags").then(function (response) {
	    ...
	    switch (this.props.loading) {
	      ...
	      case true:
	        return React.createElement(
	          "div",
	          { className: "tag-cloud" },
	          React.createElement("img", { className: "tag-cloud-spinner", src: "spinner.svg" })
	        );
	      case false:
	...
	var ExplorerButton = React.createClass({
	  displayName: "ExplorerButton",

	  propTypes: explorerButtonPropTypes,
	  render: function () {
	    return React.createElement(
	      "button",
	      { className: "explorer-button", onClick: this.props.onToggleClick },
	...
	var Explorer = React.createClass({
	  ...
	  render: function () {
	    if (!this.props.explorerShowing) {
	      return React.createElement(ExplorerButton, { explorerShowing: this.props.explorerShowing,
	        onToggleClick: this.props.onToggleClick });
	    }
	    return React.createElement(
	      "div",
	      { className: "explore" },
	      React.createElement(ExplorerButton, { explorerShowing: this.props.explorerShowing,
	        onToggleClick: this.props.onToggleClick })
	    );
	  }
	});
	  ...
	  render: function () {
	    ...
	    if (tags && tags.length) {
	      ...
	      for (var i = 0; i < tags.length; i++) {
	        ...
	        children.push(React.createElement(
	          "span",
	          { className: "trixel-tag", key: "tag-" + i },
	          tags[i]
	        ));
	      }
	    }
	    return React.createElement(
	      "div",
	      { className: "trixel" },
	      React.createElement("img", { className: "trixel-img",
	        src: "http://cdn.trixel.io/trixels/" + this.props.id + ".svg" }),
	      React.createElement(
	        "div",
	        { className: "trixel-tags" },
	        children
	      )
	    );
	  }
	  ...
	  render: function () {
	    ...
	    return React.createElement(
	      ...
	      React.createElement(
	        "div",
	        null,
	        React.createElement(Selector, _extends({}, this.props.tagCloud, {
	          retry: function () {
	            dispatch(fetchTags());
	          } })),
	        React.createElement(
	          "div",
	          null,
	          React.createElement(Trixel, { id: "1999", tags: ["ooo", "arr"] }),
	          React.createElement(Trixel, { id: "1998", tags: ["ooo", "arr"] }),
	          React.createElement(Trixel, { id: "1000", tags: ["ooo", "arr"] })
	        )
	      )
	    );
	  }
